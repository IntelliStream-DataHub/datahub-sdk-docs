...
power.setExternalId("turbine_t14_power_kw");
power.setName("Turbine T14 power");
power.setUnit("kw");
var wind = new Timeseries();
wind.setExternalId("turbine_t14_wind_ms");
wind.setName("Turbine T14 wind speed");
wind.setUnit("m_s");
...
client.timeseries.create([
    intellistream_datahub_sdk.TimeSeries(external_id="turbine_t14_power_kw",
                           name="Turbine T14 power", unit="kw"),
    intellistream_datahub_sdk.TimeSeries(external_id="turbine_t14_wind_ms",
...
rf = intellistream_datahub_sdk.RetrieveFilter(ts="turbine_t14_power_kw",
