...
client.resources.create(
    [intellistream_datahub_sdk.Resource(external_id="grid_region_east", name="Eastern region", labels=["Region"]),
     intellistream_datahub_sdk.Resource(external_id="substation_oslo_1", name="Oslo substation 1", labels=["Substation"])],
    [intellistream_datahub_sdk.RelForm.by_external_ids("grid_region_east", "substation_oslo_1", "contains")])
```
...
let mut event = Event::new(
    format!("feeder_overload_f12_{}", Utc::now().timestamp()),
    "feeder_overload".into(),
    Utc::now());
