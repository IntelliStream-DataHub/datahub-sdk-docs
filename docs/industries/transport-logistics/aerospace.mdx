...
nodes = [datahub_sdk.Resource(external_id="part_type_hp_47", name="Hydraulic pump type HP-47")]
edges = []
for ac in ["ln_312", "ln_318", "ln_401"]:
    nodes += [datahub_sdk.Resource(external_id=f"aircraft_{ac}", name=f"Aircraft {ac}"),
              datahub_sdk.Resource(external_id=f"hyd_pump_{ac}_1", name=f"Pump {ac}")]
...
client.resources.create(
    [datahub_sdk.Resource(external_id="aircraft_ln_312", name="Aircraft LN-312"),
     datahub_sdk.Resource(external_id="hyd_pump_ln_312_1", name="Hydraulic pump #1")],
