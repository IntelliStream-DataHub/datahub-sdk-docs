...
client.resources.create(
    ...
    [intellistream_datahub_sdk.RelForm.by_external_ids("station_oslo_s", "junction_lierstranda", "connects_to"),
     intellistream_datahub_sdk.RelForm.by_external_ids("junction_lierstranda", "station_drammen", "connects_to"),
     intellistream_datahub_sdk.RelForm.by_external_ids("station_drammen", "station_bergen_n", "connects_to")])
```
