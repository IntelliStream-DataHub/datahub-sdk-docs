...
client.resources.create(
    [datahub_sdk.Resource(external_id=x, name=n, labels=[lbl]) for x, n, lbl in
    ...
    [datahub_sdk.RelForm.by_external_ids("wellhead_temp_a12", "cooling_system", "PART_OF"),
     datahub_sdk.RelForm.by_external_ids("pump_temp_a12", "cooling_system", "PART_OF")])
```
