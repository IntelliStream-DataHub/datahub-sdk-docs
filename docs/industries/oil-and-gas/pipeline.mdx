...
for s, v in [("segment_pn_07_flow_in_m3h", 1000.0), ("segment_pn_07_flow_out_m3h", 940.0)]:
    client.timeseries.create([intellistream_datahub_sdk.TimeSeries(external_id=s, name=s, unit="m3h", value_type="float")])
...
client.resources.create(
    ...
    [intellistream_datahub_sdk.RelForm.by_external_ids("station_kollsnes", "segment_pn_07", "connects_to"),
     intellistream_datahub_sdk.RelForm.by_external_ids("segment_pn_07", "station_mongstad", "connects_to"),
     intellistream_datahub_sdk.RelForm.by_external_ids("segment_pn_07", "valve_v18", "isolated_by"),
     intellistream_datahub_sdk.RelForm.by_external_ids("segment_pn_07", "valve_v19", "isolated_by")])
```
...
if inflow - outflow > tolerance(inflow) {
    let mut leak = Event::new(
        format!("leak_suspected_pn07_{}", Utc::now().timestamp()),
        "leak_suspected".into(),
        Utc::now());
