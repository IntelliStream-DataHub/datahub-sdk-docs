...
```java
var moisture = new Timeseries();
moisture.setExternalId("field_north_40_soil_moisture");
moisture.setName("North 40 soil moisture");
moisture.setUnit("pct");
var soilTemp = new Timeseries();
soilTemp.setExternalId("field_north_40_soil_temp_c");
soilTemp.setName("North 40 soil temperature");
...
client.timeseries.create([
    intellistream_datahub_sdk.TimeSeries(external_id="field_north_40_soil_moisture",
        name="North 40 soil moisture", unit="pct"),
    intellistream_datahub_sdk.TimeSeries(external_id="field_north_40_soil_temp_c",
...
```python
client.files.upload_file(intellistream_datahub_sdk.FileUpload(
