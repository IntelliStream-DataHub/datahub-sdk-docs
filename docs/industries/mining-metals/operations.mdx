...
client.timeseries.create([datahub_sdk.TimeSeries(external_id="truck_785_oil_pressure_kpa", name="Truck 785 oil pressure")])
...
client.timeseries.create([datahub_sdk.TimeSeries(external_id="crusher_01_throughput_tph", name="Crusher 01 throughput")])
