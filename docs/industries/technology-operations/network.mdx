...
for c in ["cell_oslo_4412", "cell_oslo_4418"]:
    client.timeseries.create([datahub_sdk.TimeSeries(external_id=f"{c}_prb_util", name=f"{c} PRB util")])
...
client.resources.create(
    [datahub_sdk.Resource(external_id=x, name=x) for x in
     ["cell_oslo_4412", "cell_oslo_4418", "backhaul_link_88", "controller_rnc_3"]],
