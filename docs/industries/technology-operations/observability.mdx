...
client.timeseries.create([datahub_sdk.TimeSeries(external_id="service_checkout_request_latency_ms", name="Checkout p99 latency")])
...
client.resources.create(
    [datahub_sdk.Resource(external_id=x, name=x) for x in
     ["service_checkout", "service_payments", "order_db", "host_web_01"]],
