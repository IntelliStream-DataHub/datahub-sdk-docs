...
nodes = [datahub_sdk.Resource(external_id="model_acme_x200", name="Acme X200 infusion pump"),
         datahub_sdk.Resource(external_id="ward_icu", name="Intensive care")]
edges = []
for u in ["3391", "3392", "3401"]:
    nodes.append(datahub_sdk.Resource(external_id=f"pump_icu_{u}", name=f"Infusion pump {u}"))
...
client.resources.create(
    [datahub_sdk.Resource(external_id="pump_icu_3391", name="Infusion pump 3391")],
