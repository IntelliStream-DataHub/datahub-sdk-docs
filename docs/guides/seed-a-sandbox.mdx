...
```python
nodes = [
    datahub_sdk.Resource(external_id="cooling_system", name="Cooling system", labels=["System"]),
    datahub_sdk.Resource(external_id="skid_1", name="Cooling skid 1", labels=["Skid"]),
    datahub_sdk.Resource(external_id="pump_a", name="Cooling pump A", labels=["Pump"]),
    datahub_sdk.Resource(external_id="pump_b", name="Cooling pump B", labels=["Pump"]),
    datahub_sdk.Resource(external_id="sensor_a", name="Pump A discharge sensor", labels=["Sensor"]),
    datahub_sdk.Resource(external_id="sensor_b", name="Pump B discharge sensor", labels=["Sensor"]),
]
edges = [
    datahub_sdk.RelForm.by_external_ids("skid_1", "cooling_system", "PART_OF"),
    datahub_sdk.RelForm.by_external_ids("pump_a", "skid_1", "PART_OF"),
    datahub_sdk.RelForm.by_external_ids("pump_b", "skid_1", "PART_OF"),
    datahub_sdk.RelForm.by_external_ids("sensor_a", "pump_a", "PART_OF"),
    datahub_sdk.RelForm.by_external_ids("sensor_b", "pump_b", "PART_OF"),
]
...
client.events.create([
    datahub_sdk.Event(external_id=f"alarm_sensor_a_{int(now.timestamp())}",
                      type="alarm", status="open", event_time=now,
                      metadata={"resource": "sensor_a", "reason": "high discharge temperature"}),
    datahub_sdk.Event(external_id=f"alarm_sensor_b_{int(now.timestamp())}",
...
alarms = list(client.events.filter(datahub_sdk.EventFilter(
    basic_filter=datahub_sdk.BasicEventFilter(type="alarm"), limit=10)))
