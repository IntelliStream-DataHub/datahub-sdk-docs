...
Create the nodes and the edges between them together. Relationship-type names are
...
nodes = [
    datahub_sdk.Resource(external_id="plant_oslo", name="Oslo Plant"),
    datahub_sdk.Resource(external_id="line_a", name="Assembly line A"),
    datahub_sdk.Resource(external_id="press_07", name="Hydraulic press 07"),
]
edges = [
