...
client.timeseries().create(
    Timeseries.of("engine_temperature").unit("celsius"));
...
client.timeseries.create([
    datahub_sdk.TimeSeries(external_id="engine_temperature", unit="celsius")])
...
api.time_series
    .create_one(&TimeSeries::new("engine_temperature", "Engine temperature"))
    .await?;
api.time_series
